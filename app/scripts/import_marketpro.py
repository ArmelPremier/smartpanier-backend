...
STORE_NAME = "MarketPro"
SCRAPER    = ROOT_DIR / "app/scraper/scraper_marketpro.py"
RAW_JSON   = ROOT_DIR / "app/scraper/marketpro_products.json"
CLEAN_JSON = ROOT_DIR / "data/marketpro_products_clean.json"


def scrape():
    print("Scraping MarketPro...")
    subprocess.run(
